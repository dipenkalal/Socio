...
import EVAdminStation from "screens/evChargingStationModule/admin"
...
{/* Rider */}
    ...
    < Route path = "/user/addstation" element = { <EVAddStationPage/> } /> 
    < Route path = "/viewallstation" element = { <EVViewStationPage/> } />
    < Route path = "/admin/all-station" element = { <EVAdminStation/> } /> 
